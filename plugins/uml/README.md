...
[![npm version](https://img.shields.io/npm/v/@predictive-systems/editor-plugin-uml.svg)](https://www.npmjs.com/package/@predictive-systems/editor-plugin-uml)
...
```sh
$ npm install @predictive-systems/editor-plugin-uml
```
...
```js
const uml = require('@predictive-systems/editor-plugin-uml');
```
...
```js
import Viewer from '@predictive-systems/editor/dist/toustui-editor-viewer';
import uml from '@predictive-systems/editor-plugin-uml';
