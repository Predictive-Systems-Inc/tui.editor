...
| 플러그인 명 | 패키지 명 | 설명 |
| --- | --- | --- |
| [`chart`](https://github.com/nhn/tui.editor/tree/master/plugins/chart) | [`@predictive-systems/editor-plugin-chart`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-chart) | 차트를 렌더링하기 위한 플러그인 |
| [`code-syntax-highlight`](https://github.com/nhn/tui.editor/tree/master/plugins/code-syntax-highlight) | [`@predictive-systems/editor-plugin-code-syntax-highlight`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-code-syntax-highlight) | 코드 하이라이팅을 위한 플러그인 |
| [`color-syntax`](https://github.com/nhn/tui.editor/tree/master/plugins/color-syntax) | [`@predictive-systems/editor-plugin-color-syntax`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-color-syntax) | 컬러피커 사용을 위한 플러그인 |
| [`table-merged-cell`](https://github.com/nhn/tui.editor/tree/master/plugins/table-merged-cell) | [`@predictive-systems/editor-plugin-table-merged-cell`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-table-merged-cell) | 병합 테이블 셀을 사용하기 위한 플러그인 |
| [`uml`](https://github.com/nhn/tui.editor/tree/master/plugins/uml) | [`@predictive-systems/editor-plugin-uml`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-uml) | UML 사용을 위한 플러그인 |
...
CLI를 사용하여 각 플러그인을 설치할 수 있다. 설치할 플러그인의 이름을 아래의 `${pluginName}`에 작성하여 설치한다. 예를 들어 `chart` 플러그인을 설치할 경우 `npm install @predictive-systems/editor-plugin-chart`로 설치한다.

```sh
$ npm install --save @predictive-systems/editor-plugin-${pluginName} 
$ npm install --save @predictive-systems/editor-plugin-${pluginName}@<version>
```
...
* `usageStatistics`: 해당 플러그인을 `@predictive-systems/editor`의 GA로 수집할지 결정한다.
