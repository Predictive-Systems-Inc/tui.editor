...
| --- | --- | --- |
| [`chart`](https://github.com/nhn/tui.editor/tree/master/plugins/chart) | [`@predictive-systems/editor-plugin-chart`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-chart) | Plugin to render chart |
| [`code-syntax-highlight`](https://github.com/nhn/tui.editor/tree/master/plugins/code-syntax-highlight) | [`@predictive-systems/editor-plugin-code-syntax-highlight`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-code-syntax-highlight) | Plugin to highlight code syntax |
| [`color-syntax`](https://github.com/nhn/tui.editor/tree/master/plugins/color-syntax) | [`@predictive-systems/editor-plugin-color-syntax`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-color-syntax) | Plugin to color editing text |
| [`table-merged-cell`](https://github.com/nhn/tui.editor/tree/master/plugins/table-merged-cell) | [`@predictive-systems/editor-plugin-table-merged-cell`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-table-merged-cell) | Plugin to merge table cells |
| [`uml`](https://github.com/nhn/tui.editor/tree/master/plugins/uml) | [`@predictive-systems/editor-plugin-uml`](https://www.npmjs.com/package/@predictive-systems/editor-plugin-uml) | Plugin to render UML |
...
You can install each plugin using the command, and add the name of the plugin you want to install to `${pluginName}` below. For example, if you install the `chart` plugin, install it as`npm install @predictive-systems/editor-plugin-chart`.

```sh
$ npm install --save @predictive-systems/editor-plugin-${pluginName} # Latest Version
$ npm install --save @predictive-systems/editor-plugin-${pluginName}@<version> # Specific Version
```
...
```
- node_modules/
   ├─ @predictive-systems/editor-plugin-${pluginName}
   │     ├─ dist/
...
```js
import pluginFn from '@predictive-systems/editor-plugin-${pluginName}';
```

- CommonJS

```js
const pluginFn = require('@predictive-systems/editor-plugin-${pluginName}');
```

For example, `chart` plugin can be imported as follows:

```js
import chart from '@predictive-systems/editor-plugin-chart';
```
...
import chart from '@predictive-systems/editor-plugin-chart';
import uml from '@predictive-systems/editor-plugin-uml';
...
* `usageStatistics`: It decides whether to collect the plugin as GA for `@predictive-systems/editor`.
