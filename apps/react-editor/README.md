...
[![npm version](https://img.shields.io/npm/v/@predictive-systems/react-editor.svg)](https://www.npmjs.com/package/@predictive-systems/react-editor)
...
```sh
npm install --save @predictive-systems/react-editor
```
...
You can use TOAST UI Editor for React as a ECMAScript module or a CommonJS module. As this module does not contain CSS files, you should import `toastui-editor.css` from `@predictive-systems/editor` in the script.
...
import { Editor } from '@predictive-systems/react-editor';
```
...
const { Editor } = require('@predictive-systems/react-editor');
```
