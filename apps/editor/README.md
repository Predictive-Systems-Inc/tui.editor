...
[![npm](https://img.shields.io/npm/v/@predictive-systems/editor.svg)](https://www.npmjs.com/package/@predictive-systems/editor)
...
```sh
$ npm install --save @predictive-systems/editor # Latest Version
$ npm install --save @predictive-systems/editor@<version> # Specific Version
```
...
```javascript
import '@predictive-systems/editor/dist/toastui-editor.css'; // Editor's Style
```
